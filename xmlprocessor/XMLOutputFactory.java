...
public abstract class XMLOutputFactory {
	 ...
	 * to determine the XMLOutputFactory implementation class to load: Use the
	 * javax.xml.stream.XMLOutputFactory system property. Use the properties
	 * file "lib/stax.properties" in the JRE directory. This configuration file
	 ...
	 * specification), if available, to determine the classname. The Services
	 * API will look for a classname in the file
	 * META-INF/services/javax.xml.stream.XMLOutputFactory in jars available to
	 * the runtime. Platform default XMLOutputFactory instance.
	 * 
	...
	public static XMLInputFactory newInstance(String factoryId,
		...
		try {
			...
			// exception
			return (XMLInputFactory) FactoryFinder.newInstance(factoryId,
					classLoader, false);
	...
	public static XMLOutputFactory newFactory(String factoryId,
		...
		try {
			// do not fallback if given classloader can't find the class, throw
			// exception
			return (XMLOutputFactory) FactoryFinder.newInstance(factoryId,
					classLoader, false);
		} catch (FactoryFinder.ConfigurationError e) {
			throw new FactoryConfigurationError(e.getException(),
					e.getMessage());
